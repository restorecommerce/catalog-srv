...
ENV HOME=/home/app
ENV APP_HOME=/home/app/catalog-srv
...
# To build the image:
# docker build -t restorecommerce/catalog-srv .
#
# To create a container:
# docker create --name catalog-srv --net restorecms_default restorecommerce/catalog-srv
#
# To run the container:
# docker start catalog-srv
